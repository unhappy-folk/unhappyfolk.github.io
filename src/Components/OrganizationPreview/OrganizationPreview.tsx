    ...
    <Card>
      <div className="w-full pt-2" dir={direction}>
        <div className="w-full mx-auto flex flex-col justify-center items-center lg:flex-row">
          <div className="mx-auto flex justify-center  items-center w-32 h-32 mx-4 flex-grow-0 flex-shrink-0 lg:self-center">
        ...
        <div className="flex justify-center items-center mb-3">
          <a
            ...
            className="text-[#e0bb3f] text-lg md:text-xl lg:text-2xl bg-stone-900 m-1 sm:m-5 rounded-lg py-3 px-6 shadow-md shadow-stone-400 hover:shadow-lg ease-in-out duration-300"
          >
          ...
          {org.contribution && (
            <Link
              ...
              rel="noreferrer"
            >
              <button className="text-[#e0bb3f] text-lg md:text-xl lg:text-2xl bg-zinc-50 m-1 sm:m-5 rounded-lg py-3 px-6 shadow-md hover:shadow-lg ease-in-out duration-300">
